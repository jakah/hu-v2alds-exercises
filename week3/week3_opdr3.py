class BSTNode:
    ...
    def rinsert(self,e):
        if self.element < e:
            if self.right is None:
                ...
                return self.right.insert(e)
        if self.element > e:
            if self.left is None:
                self.none = BSTNode(e,None,None)
            else:
                return self.left.insert(e)
    ...
    def max(self):
        if self.left is not None and self.element < self.left.max():
            return self.left.max()
        if self.right is not None and self.element < self.right.max():
            return self.right.max()
        return self.element

    def rsearch(self,e):
        if self.element is e:
            return self
        elif self.element < e and self.right is not None:
            return self.right.rsearch(e)
        elif self.element > e and self.left is not None:
